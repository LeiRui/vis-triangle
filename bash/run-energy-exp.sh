...
$HOME_PATH/tool.sh MAX_HEAP_SIZE \"6G\" $HOME_PATH/iotdb-server-0.12.4/conf/iotdb-env.sh
...
$HOME_PATH/tool.sh write_read_schema_free_memory_proportion 1:6:1:2 $HOME_PATH/iotdb-server-0.12.4/conf/iotdb-engine.properties
